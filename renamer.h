...
private:
	...
	uint64_t numberOfBranches;
	uint64_t prfSize;
	uint64_t mappingTableSize;

	/////////////////////////////////////////////////////////////////////
	// Structure 1: Rename Map Table
	// Entry contains: physical register mapping
	/////////////////////////////////////////////////////////////////////
  struct renameMapTable {
    uint64_t rmtMapping;
    };

	vector<renameMapTable> rmt;
	/////////////////////////////////////////////////////////////////////
	// Structure 2: Architectural Map Table
	// Entry contains: physical register mapping
	/////////////////////////////////////////////////////////////////////
	struct architecturalMapTable {
		uint64_t amtMapping;
	};

	vector<architecturalMapTable> amt;
	/////////////////////////////////////////////////////////////////////
	...
	struct freeList {
		...
		vector<uint64_t> freeListMapping;
        uint64_t headIndex, tailIndex;
	...
	/////////////////////////////////////////////////////////////////////
	    ...
	    struct activeListEntry{
          bool destFlag;
          uint64_t logicalRegIndex;
          uint64_t physicalRegIndex;
          bool isComplete;
          bool exception;
          bool isLoadViolated;
          bool isBranchMispredicted;
          bool isValueMispredicted;
          bool isLoadInstr;
          bool isStoreInstr;
          bool isBranchInstr;
          bool isAtomicOper;
		...
		struct activeList{
		  ...
		  vector<activeListEntry> activeListMapping;
          uint64_t headIndex, tailIndex;
          bool headPhase,tailPhase;
          };
	...
	/////////////////////////////////////////////////////////////////////
		struct physicalRegFileEntry{

		uint64_t phyRegisterValue;
		bool physRegReadyBit;

		};

		// struct physicalRegFile{
		// 	vector<physicalRegFileEntry> prf;
		// }
		vector<physicalRegFileEntry> prf;
	...
	struct branchCheckpoint{
		...
		uint64_t checkPointedFLHeadIndex;
		bool checkPointedFLHeadPhase;
		uint64_t checkPointedGBM;
	};

	vector<branchCheckpoint> branchCheckpointTable;
